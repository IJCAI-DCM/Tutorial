...
% F    - second level free energy over iterations
% -------------------------------------------------------------
...
for k = 1:2
    ...
    % US_20221123: changed line, call of nae_spm_dcm_fit fct.
    % spm_dcm_fit can handle group DCMs, spm_dcm_csd cannot
    try, DCM  = nae_spm_dcm_fit(DCM); catch, break;  end 
